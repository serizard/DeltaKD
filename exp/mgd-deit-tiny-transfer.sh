...
#     --weight-decay 1e-4 \
#     --gpus $GPU_IDS \
#     --distillation-type mgd \
#     --log-file logs/mgd-deit-tiny-stanford-cars.log \
#     --save-dir checkpoints/mgd-deit-tiny-stanford-cars \
#     --wandb \
#     --wandb-project AAAKD
...
CUDA_VISIBLE_DEVICES=$GPU_IDS torchrun --nproc_per_node=$NUM_GPUS --master_port $MASTER_PORT tools/train.py \
    ...
    --gpus $GPU_IDS \
    --distillation-type mgd \
    --log-file logs/mgd-deit-tiny-flowers.log \
    --save-dir checkpoints/mgd-deit-tiny-flowers \
    --wandb \
    --wandb-project AAAKD
...
CUDA_VISIBLE_DEVICES=$GPU_IDS torchrun --nproc_per_node=$NUM_GPUS --master_port $MASTER_PORT tools/train.py \
    ...
    --gpus $GPU_IDS \
    --distillation-type mgd \
    --log-file logs/mgd-deit-tiny-caltech256.log \
    --save-dir checkpoints/mgd-deit-tiny-caltech256 \
    --wandb \
    --wandb-project AAAKD
